...
public class QQHealthView extends View{
    ...
    public QQHealthView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.getTheme().obtainStyledAttributes(attrs,
                R.styleable.QQHealthView, defStyleAttr,0);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.e("WLH", "onMeasure---" + " widthBg:"+widthBg +" heightMode:"+heightMode+ " heightBg:"+heightBg);
        startAnim();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //圆弧范围
        arcRect = new RectF(widthBg / 4, widthBg / 4, widthBg * 3 / 4, widthBg * 3 / 4);
        //绘制背景大圆弧
        ...
        canvas.drawText(String.valueOf(walkNum), widthBg * 3 / 8, widthBg / 2 + 20, textPaint);

        //绘制名次
        textPaint.setTextSize(widthBg / 15);
        canvas.drawText(String.valueOf(rankNum), widthBg / 2 -15, widthBg * 3 / 4, textPaint);;
